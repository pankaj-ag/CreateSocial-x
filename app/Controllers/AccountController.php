...
class AccountController extends UserBaseController
{
    ...
    public function credits() {
        return $this->render('user.account.credits', ['user' => $this->userRepository->findById(\Auth::user()->id), 'users' => app('App\\Repositories\\UserRepository')->latestUsers(8)], [
            'title' => $this->setTitle(trans('user.credits'))
        ]);
    }
