        ...
        <div class=" user media media">
            ...
            <div class="media-body">
                ...
                <p>
                    ...
                    <a  data-is-login="{{Auth::check()}}" data-status="{{($hasLike) ? '1' : 0}}" class="btn btn-default btn-xs like-button" data-like="Like" data-unlike="Unlike" data-id="{{$game->id}}" data-type="game" href=""><i class="icon ion-thumbsup"></i> <span>{{($hasLike) ? 'Unlike' : 'Like'}}</span></a>
					</span>
                </p>
            </div>
        </div>
