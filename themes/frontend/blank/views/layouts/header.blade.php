...
<html lang="en">
    ...
    <header id="header" class="navbar navbar-default  navbar-fixed-top" style="{{Config::get('blank-header-color', '')}}!important" role="banner">

          <div class="container">
            <div class="navbar-header">

              <a title="Go to home" href="{{URL::to('/')}}" data-ajaxify="true" class="navbar-brand"><img src="{{Theme::asset()->img('theme/images/logo.png')}}"/> </a>
            </div>
              ...
              @if(Auth::check())
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown" id="main-menu">
                                <a  class="dropdown-toggle"  data-toggle="dropdown" href="" style="color:{{Config::get('blank-header-iconcol', '')}} !important;">
                            ...
                            @endif
                        <li class="header-nav">
                            <a href="{{URL::route('user-home')}}" style="color:{{Config::get('blank-header-iconcol', '')}} !important;" data-ajaxify="true"><i class="icon ion-home"></i></a>
                        </li>
                        ...
                        <li id="notification-link" class="notification-link">
                            ...
                            <a href="" id="notification-dropdown-trigger" class="notification-dropdown-trigger" style="color:{{Config::get('blank-header-iconcol', '')}} !important;"><i class="icon ion-ios-bell-outline"></i>
                        ...
                        <li class="notification-link">
                            ...
                            <a class="friend-request-trigger" id='friend-request-trigger' href="{{URL::route('friend-requests')}}"style="color:{{Config::get('blank-header-iconcol', '')}} !important;"><i class="icon ion-person-stalker"></i> {{(!empty($countRequest)) ?'<span>'.$countRequest. '</span>' : null}}</a>
                        ...
                        <li id="message-dropdown-link" class="notification-link">
                            ...
                            <a href="" class="new-messages-trigger" id='new-messages-trigger' style="color:{{Config::get('blank-header-iconcol', '')}} !important;"><i class="icon ion-ios-chatboxes-outline"></i>
                        ...
                        <li class="dropdown account-menu notification-link">
                            <a data-toggle="dropdown" data-click="dropdown" class="dropdown-toggle" href="" style="color:{{Config::get('blank-header-iconcol', '')}} !important;">
              ...
              @else
                    <ul id="change-language" class="navbar-nav nav navbar-right">
                        @if(Request::segment(1))
                            <li>
                                <a href="{{URL::to('/')}}" style="color:{{Config::get('blank-header-iconcol', '')}} !important;"">{{trans('user.login-signup-here')}}</a>
                            </li>
                        @endif
                        <li class="dropdown">
                            <a data-toggle="dropdown" data-click="dropdown" class="dropdown-toggle" href="">{{trans('global.change-language')}} <i class="caret"></i></a>
                            <ul class="dropdown-menu">
              ...
              @endif
                ...
                <ul id="header-mobile-nav" class=" nav navbar-nav visible-xs navbar-right">
                    ...
                    <li class="notification-link">
                        ...
                        <li class="notification-link">
                            <a class="new-messages-trigger" href="{{URL::route('messages')}}" id=''><i class="icon ion-ios-chatboxes-outline"></i>
                                {{($countMessage) ? '<span>'.$countMessage.'</span>' : null}}
                            </a>
                        </li>
                    @endif
