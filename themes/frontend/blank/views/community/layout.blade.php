<div class="container page-content">
    ...
    <div class="left-column">
        ...
        <ul class="nav user-action-buttons">
            <li><a href="{{URL::route('community-create')}}" data-ajaxify="true"><i class="icon ion-ios-personadd-outline"></i> <span>{{trans('community.create')}}</span></a> </li>
            <li><a href="{{URL::route('communities')}}" data-ajaxify="true"><i class="icon ion-disc"></i> <span>{{trans('community.my-communities')}}</span></a> </li>
            <li><a href="{{URL::route('communities-joined')}}" data-ajaxify="true"><i class="icon ion-ios-people-outline"></i> <span>{{trans('community.joined')}}</span></a> </li>
