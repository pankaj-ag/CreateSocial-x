...
<div class="box">
				...
				<div class="box-title"">
					...
					<span class="pull-right dropdown">
						<a class="dropdown-toggle" data-click="dropdown" data-toggle="dropdown" href=""><i class="icon ion-chevron-down"></i></a>
						<ul class="dropdown-menu">
							...
							@if($community->present()->isMember())
										...
										<li><a data-userid="{{Auth::user()->id}}" data-on="On Notifications" data-status="{{$nStatus}}" data-off="Off Notifications" class="toggle-notification-receiver" data-type="community" data-type-id="{{$community->id}}" href="">
											<span>
												@if ($nStatus)
	...
	<div class="box">
		...
		<div class="box-content  box-content-xs">
			{{Theme::section('user.display', ['user' => $community->user, 'mini' => false, 'miniActions' => true])}}
		</div>
	</div>
