    ...
    <div class="post-footer">
        <ul class="nav nav-left">
            ...
            <?php 
                ...
                <a data-userid="{{Auth::user()->id}}" data-on="{{trans('newlang.favorite')}}" data-status="{{$nStatus}}" data-off="{{trans('newlang.favorite')}}" class="toggle-notification-receiver favorite" data-type="post" data-type-id="{{$post->id}}" href="">
                    <i class="icon ion-ios7-bell-outline"></i>

                        <span>
                            @if ($nStatus)
                                {{trans('newlang.favorite')}}
                            @else
                                {{trans('newlang.favorite')}}
                            @endif
                        </span>
