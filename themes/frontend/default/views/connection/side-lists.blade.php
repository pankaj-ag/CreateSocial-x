...
@if(count($followers))
    <div class="box">
        <div class="box-title">
            ...
            <a href="{{$profileUser->present()->url('connection/followers')}}" class="pull-right"><i class="icon ion-more"></i> {{trans('global.view-all')}}</a><p>hii</p>
        </div>
        <div class="box-content">
    ...
    <div class="box">
        ...
        <div class="box-content">
            ...
            <div class="user-tile-list">
                ...
                <a data-ajaxify="true" href="{{$followedUser->toUser->present()->url()}}"><img src="{{$followedUser->toUser->present()->getAvatar(100)}}"/> </a><p>helloo</p>
                    @endif
                @endforeach
